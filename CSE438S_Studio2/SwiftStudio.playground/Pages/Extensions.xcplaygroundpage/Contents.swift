...
extension String{
    // CITATION: https://www.hackingwithswift.com/example-code/strings/how-to-read-a-single-character-from-a-string
    ...
    func removeVowels() -> String{
        ...
        for i in 0 ..< self.count{
            if (!(self[i] == "a" || self[i] == "e" || self[i] == "i" || self[i] == "o" || self[i] == "u")){
                tmp += self[i]
            }
        }
        return tmp
